...
Pod::Spec.new do |s|
  s.name             = 'RFontManager'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RFontManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Reza Khonsari/RFontManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Reza Khonsari' => 'rezakhonsari@icloud.com' }
  s.source           = { :git => 'https://github.com/Reza Khonsari/RFontManager.git', :tag => s.version.to_s }
